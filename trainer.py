...
def trainer(args, model):
    ...
    if args.dataset == datafile_name:  # 默认
        db_train = Synapse_dataset(base_dir=args.train_path, list_dir='./lists/lists_Synapse', split="train",
                               transform=transforms.Compose(
                                   [RandomGenerator(output_size=[args.img_size, args.img_size])]))
        db_validate = Synapse_dataset(base_dir='data/'+datafile_name+'/test_vol/', list_dir='./lists/lists_Synapse', split="test_vol",
                               transform=transforms.Compose(
                                   [RandomGenerator(output_size=[args.img_size, args.img_size])]))
